...
export const Sidebar = () => {
  ...
  return (
    <aside className="sticky top-0 h-screen w-64 flex flex-col z-50 border-r border-border bg-secondary shrink-0">
      {/* Logo */}
      <div className="p-6">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-105 shadow-lg shadow-primary/20 bg-primary">
